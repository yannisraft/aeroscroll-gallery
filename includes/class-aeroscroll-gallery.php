...
if (!class_exists('aeroscroll_gallery')) {
    ...
    class aeroscroll_gallery
    {
        ...
        private function load_dependencies()
        {
             ...
             * core plugin.
             */
            require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-aeroscroll-gallery-loader.php';

            /**
             * The class responsible for defining internationalization functionality
             * of the plugin.
             */
            require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-aeroscroll-gallery-i18n.php';

            /**
             * The class responsible for defining all custome REST API endpointd
             * 
             */
            require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-aeroscroll-gallery-custom-endpoint.php';

            /**
             * The class responsible for defining all actions that occur in the admin area.
             */
            require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-aeroscroll-gallery-admin.php';

            /**
             * The class responsible for defining all actions that occur in the public-facing
             * side of the site.
             */
            require_once plugin_dir_path(dirname(__FILE__)) . 'public/class-aeroscroll-gallery-public.php';



            $this->loader = new aeroscroll_gallery_Loader();
            $this->customendpoint = new aeroscroll_gallery_Api_Endpoint();
        }
        ...
        {            
            $plugin_admin = new aeroscroll_gallery_Admin($this->get_plugin_name(), $this->get_version());

            // Hook our settings
            $this->loader->add_action('admin_init', $plugin_admin, 'register_aeroscroll_settings');
            $this->loader->add_action('admin_menu', $plugin_admin, 'register_aeroscroll_settings_page');
            $this->loader->add_action('admin_print_styles', $plugin_admin, 'enqueue_styles');
            $this->loader->add_action('admin_enqueue_scripts', $plugin_admin, 'enqueue_scripts');

            //error_log("AEROSCROLL_GALLERY_PRO_VERSION: ".AEROSCROLL_GALLERY_PRO_VERSION);
        }
        ...
        {
            $plugin_public = new aeroscroll_gallery_Public($this->get_plugin_name(), $this->get_version());
